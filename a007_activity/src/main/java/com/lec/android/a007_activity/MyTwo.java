...
public class MyTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int c = intent.getIntExtra("num3",999); //"num3"라는 이름이 없었다. 고로, defaultValue인 999로 리턴.
        long l = intent.getLongExtra("long",0);

        String msg = intent.getStringExtra("msg"); //리턴값이 object인 경우, 디폴트 값 설정 없다. name이 없으면 null 리턴.
